...
<head>
    <meta charset="utf-8" />
    <title>Iniciar Sesión - Ssmike S.A</title>
...
<body class="body">
    ...
    <center>
        ...
        <form action="../controller/controllerusuario.php" class="formulario" method="post">
            ...
            <div class="contendedor">
                ...
                <p style="color: #6d4c41;">¿Es tu primera vez? <a style="color: #6d4c41;" class="link" href="register.php">Registrarse</a></p>
                <br>
                <p style="color: #6d4c41;">¿Eres administrador? <a style="color: #6d4c41;" class="link" href="logginadmin.php">Ingresar como administrador</a></p>
            </div>
        </form>
    </center>
    <br><br><br><br><br>
