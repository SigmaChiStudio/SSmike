<nav style="background-color:#464646;" class="navbar navbar-expand-lg navbar-dark fixed-top nav" id="mainNav">
    <div class="container">
        <a style="font-size: 30px;" class="navbar-brand js-scroll-trigger" id="navbar-brand2" href="indexadmin.php"><img src="../model/img/navbar-logo.png" alt="Logo Ssmike"/> Ssmike <br></a>
