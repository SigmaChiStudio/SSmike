...
<body class="body">
        ...
        <center>
                ...
                <form action="../controller/controllerusuario.php" class="formularioR" method="post">
                        ...
                        <div class="contendedor">
                                ...
                                <div>
                                        ...
                                        <input type="text" placeholder="Télefono/Celular" name="telefono" required>
                                </div>
                                <div>
                                        <i class="fas fa-unlock-alt icon"></i>
                                ...
                                <p style="color: #6d4c41;">¿Ya tienes una cuenta? <a style="color: #6d4c41;" class="link" href="Loggin.php">Iniciar sesión</a></p>
                        </div>
                </form>
        </center>
        <br><br>
